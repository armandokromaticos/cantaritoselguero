...
export class ProductEntity {
  ...
  constructor(props: ProductProps, _fromDB = false) {
    this.props = props;
  }
  ...
  get stock(): number | null { return this.props.stock; }
  get isActive(): boolean { return this.props.isActive; }
  get standId(): string | null { return this.props.standId; }
  ...
  toPrismaUpdate(): Record<string, unknown> {
    ...
    if (this.props.basePrice !== undefined)
      data.basePrice = new Prisma.Decimal(this.props.basePrice);
    if (this.props.image !== undefined) data.image = this.props.image;
    if (this.props.stock !== undefined) data.stock = this.props.stock;
    if (this.props.isActive !== undefined) data.isActive = this.props.isActive;
    if (this.props.standId !== undefined) {
      data.stand = this.props.standId
        ? { connect: { id: this.props.standId } }
        : { disconnect: true };
    }
    return data;
  }
